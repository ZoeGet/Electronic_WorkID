...
uint8_t KEY_Scan2(void)
{
  ...
  if(key_up && (KEY0 == KEY0_ON || KEY1 == KEY1_ON))
  {
    HAL_Delay(10);
    key_up = 0;
    if(KEY0 == KEY0_ON)
  ...
  else if(KEY0 == KEY0_OFF && KEY1 == KEY1_OFF) key_up = 1;//按键松开时key_up重置，下次再按下才会触发
  return 0;
}
...
uint8_t KEY_Scan(uint8_t mode)
{
  ...
  if(key_up == 1 && (KEY0 == KEY0_ON || KEY1 == KEY1_ON))
  {
    // 非阻塞式消抖：检查按键状态是否稳定
  ...
  else if(KEY0 == KEY0_OFF && KEY1 == KEY1_OFF) {
